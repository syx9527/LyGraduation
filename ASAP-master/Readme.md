...
pip install torch-geometric==1.4.3
```
pip install torch-scatter==2.0.* -f https://pytorch-geometric.com/whl/torch-1.5.0.html --proxy=127.0.0.1:4780
pip install torch-scatter --proxy=127.0.0.1:4780
pip install torch-sparse --proxy=127.0.0.1:4780
pip install torch-geometric --proxy=127.0.0.1:4780
